...
## Session 13 (Octopus (?): `r pdt(savingSessions_dateTimes_DT[ID == 13, start_hh])`)

```{r}
start_hh <- savingSessions_dateTimes_DT[ID == 13, start_hh]
end_hh <- savingSessions_dateTimes_DT[ID == 13, end_hh]
actualEnd <- savingSessions_dateTimes_DT[ID == 13, end_hh] + 30*60
```
