 ...
 * [changes to the twitter API policy](https://twitter.com/TwitterDev) which may have reduced the availability of tweets from February 2023. It is currentrly unclear whether a [free API access tier](https://developer.twitter.com/en/products/twitter-api) will be available or [per-project academic research access](https://developer.twitter.com/en/products/twitter-api/academic-research) will be required.
