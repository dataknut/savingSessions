...
If all [~28 million households](https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/families/bulletins/familiesandhouseholds/2021) in the UK did this it would be `r scaled_kW` kW. That's actually `r scaled_GW` GW, no?


Which would be `r round(scaled_GW_pc,2)` % of generation.
