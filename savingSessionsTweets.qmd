...
Repeat these word clouds but just for the first session which started at `r session1DateStart`.
...
Repeat for session 2 which started at `r session2DateStart`.
...
Repeat for session 2 which started at `r session3DateStart`.
...
Repeat for session 2 which started at `r session4DateStart`.
...
Repeat for session 2 which started at `r session5DateStart`.
